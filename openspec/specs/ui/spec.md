...
# UI Specification — refactor de ProductCard en container puro y sub-componentes presentacionales
...
### Requirement: REQ-001 — Mensajes de WhatsApp byte-idénticos
...
### Requirement: REQ-002 — Flujo del modal de crédito funcional-idéntico
...
### Requirement: REQ-003 — Contrato de props de `ProductCard` intacto
...
### Requirement: REQ-004 — Sin cambio de UI visible
...
### Requirement: REQ-005 — Gates continuos — lint 0/0 y suite verde
...
### Requirement: REQ-006 — Tests de caracterización ANTES de tocar la implementación
...
### Requirement: REQ-007 — Registro de vistas preservado
...
### Requirement: REQ-008 — Sin deploy y cero cambios de infraestructura
